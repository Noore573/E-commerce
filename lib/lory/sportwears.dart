...
ProductDetailController controllerpf = Get.put(ProductDetailController());
  ...
  Widget build(BuildContext context) {
    controllerpf.profiltercatcontroller('sport wears',gender.value);
    ...
    return GetBuilder<ProductDetailController>(
        ...
        appBar: new AppBar(
          ...
          title: Center(child: Text("Sport Wears",style: TextStyle(fontWeight: FontWeight.w700,color: Colors.white),)),
        ),
          body:
          ListView(
              children:[ 
