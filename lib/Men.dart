...
//import 'package:untitled4/modules/Men/Men_controller.dart';
class Men extends StatelessWidget {
 // MenController controller= Get.find();
  List<ProductItem> itemss=[
    ProductItem(
      AssetImage:'images/3.jpg',title:'GUCCI',subtitle:'\$200',
    ),
    ProductItem(
      AssetImage:'images/4.jpg',title:'Zara',subtitle:'\$100',
    ),
    ProductItem(
      AssetImage:'images/6.jpg',title:'GUCCI',subtitle:'\$88',
    ),
    ProductItem(
      AssetImage:'images/7.jpg',title:'GUCCI',subtitle:'\$100',
    ),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body:ListView(
            children:[
              SizedBox(height: 180,width: double.infinity,child:Image.asset('images/8.jpg'), ),
              SizedBox(height: 20,),
              Container(
                  ...
                  child:  Row(
                      children: [
                        Container(height: 70,
                          ...
                          child: InkWell(onTap: (){Get.toNamed("/dress");},child:Image.asset('images/3.jpg',)),
                        ),
                        Container(height: 70,
                          margin: EdgeInsets.all(10),
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color: Colors.white60),
                          child: InkWell(child: Image.asset('images/3.jpg')),
                        ),
                        Container(height: 70,
                          margin: EdgeInsets.all(10),
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color: Colors.white60),
                  ...
                  child:  Row(
                      children: [
                        Container(height: 70,
                          margin: EdgeInsets.all(10),
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color: Colors.white60),
                          child: InkWell(child: Image.asset('images/10.jpg')),
                        ),
                        Container(height: 70,
                          margin: EdgeInsets.all(10),
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color: Colors.white60),
