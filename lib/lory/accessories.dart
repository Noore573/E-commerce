...
ProductDetailController controllerpf = Get.put(ProductDetailController());
  ...
  Widget build(BuildContext context) {
    controllerpf.profiltercatcontroller('accessories',gender.value);
    ...
    return GetBuilder<ProductDetailController>(
        ...
        appBar: new AppBar(
          ...
          title: Center(child: Text("Accessories",style: TextStyle(fontWeight: FontWeight.w700,color: Colors.white),)),
        ),
          body:
          ListView(
              children:[
